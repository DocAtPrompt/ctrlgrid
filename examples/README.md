...
notebook of sections, a calligraphy guide, a box net to cut out and a sheet with
a printed ruler along its edges.
...
| <img src="previews/16-net-tray.png" width="220"> | **`net`** — an 80 × 50 × 30 mm tray: base, four walls, four glue tabs, cut lines solid and creases dashed. Print at 100 %, cut, fold — if it closes, nothing scaled it. Dimensions are the *inner* ones.<br>[`16-net-tray.yaml`](16-net-tray.yaml) · [PDF](16-net-tray.pdf) · preset [`box-tuck-a4`](../ctrlgrid/data/presets/box-tuck-a4.yaml) |
